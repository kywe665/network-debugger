    ...
    var template =
      '<div data-name="'+port+'" class="js-ui-tab-view css-ui-tab-view js-all css-inactive">'+
        ...
        '<div class="css-connection-info">'+
          '<a data-protocol="'+protocol+'" data-port="'+port+'" class="css-button css-openSocket js-reopen js-'+port+'">Open Connection</a>'+
          '<div class="css-connection-status js-'+protocol+'-connection-status off">Connection Status</div>'+
        '</div>'+
        '<div class="css-top right">'+
          '<p>Save each packet separately</p>'+
          '<input type="checkbox" checked="true" class="js-'+protocol+'-multifile">'+
